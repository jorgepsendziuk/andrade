...
class ArquivoCNHForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Anexar CNH:");
...
$label = new TLabel('Olá ' . $dadosPessoais->nome . '. <br/><br/>Envie o arquivo da sua CNH.<br/><br/>');  
...
$this->form->addContent([$label]);
        ...
        $btn_onsave = $this->form->addAction("Enviar", new TAction([$this, 'onSave']), 'far:arrow-alt-circle-right #ffffff');
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cliente","Anexar CNH"]));
        }
...
$tstep->addItem('Anexar CNH', true, false);
