...
echo "  6. Salvar"
echo ""
echo "  A tabela será criada automaticamente (um destes nomes):"
echo "    gcp_billing_export_v1_${BILLING_ACCOUNT//-/_}           (Detailed usage cost)"
echo "    gcp_billing_export_resource_v1_${BILLING_ACCOUNT//-/_}  (Resource-level — já suportado)"
echo ""
