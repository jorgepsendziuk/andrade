...
class PagamentoStatus extends TRecord
{
    const TABLENAME  = 'pagamento_status';
    const PRIMARYKEY = 'id';
    ...
    public function getContratos()
    {
        ...
        $criteria->add(new TFilter('pagamento_status', '=', $this->id));
    ...
    public function get_contrato_cliente_to_string()
    {
        ...
        $values = Contrato::where('pagamento_status', '=', $this->id)->getIndexedArray('id_cliente','{cliente->id}');
    ...
    public function get_contrato_carro_to_string()
    {
        ...
        $values = Contrato::where('pagamento_status', '=', $this->id)->getIndexedArray('id_carro','{carro->id}');
        return implode(', ', $values);
    }
    ...
    public function get_contrato_fk_pagamento_tipo_to_string()
    {
        ...
        $values = Contrato::where('pagamento_status', '=', $this->id)->getIndexedArray('pagamento_tipo','{fk_pagamento_tipo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_contrato_fk_pagamento_status_to_string()
    {
        ...
        $values = Contrato::where('pagamento_status', '=', $this->id)->getIndexedArray('pagamento_status','{fk_pagamento_status->id}');
        return implode(', ', $values);
    }
