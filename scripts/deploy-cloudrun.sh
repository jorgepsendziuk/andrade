...
GOOGLE_ADS_ID="${VITE_GOOGLE_ADS_ID:-AW-18420852145}"
GOOGLE_ADS_CONVERSION_LABEL="${VITE_GOOGLE_ADS_CONVERSION_LABEL:-w97QCKinq-wcELHL389E}"
BUILD_ENV="VITE_SITE_URL=https://andradeisencoes.com.br,VITE_GA4_PROPERTY_ID=${VITE_GA4_PROPERTY_ID:-347102827},VITE_GA_MEASUREMENT_ID=${GA_MEASUREMENT_ID},VITE_GOOGLE_ADS_ID=${GOOGLE_ADS_ID},VITE_GOOGLE_ADS_CONVERSION_LABEL=${GOOGLE_ADS_CONVERSION_LABEL},BUILD_CACHE_BUST=$(date +%s)"
echo "→ GA4 measurement ID: ${GA_MEASUREMENT_ID}"
echo "→ Google Ads ID: ${GOOGLE_ADS_ID}"
